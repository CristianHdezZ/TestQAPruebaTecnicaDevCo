...
import static co.com.project.certification.devco.userinterface.SearchPaquetesPage.*;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isVisible;

public class SearchTravelocityPaquete implements Task {
    private String strOrigen;
    private String strDestino;

    public SearchTravelocityPaquete(String strOrigen, String strDestino) {
        this.strOrigen = strOrigen;
        this.strDestino = strDestino;
    }

    public static SearchTravelocityPaquete inTheMouleWith(String origen, String destino) {
        return Tasks.instrumented(SearchTravelocityPaquete.class,origen,destino);
    }
